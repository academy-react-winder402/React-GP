            ...
            <div className='hidden lg:block xl:hidden'>
                <div className='flex pt-3 h-[70px]'>
                    ...
                    <div className="flex gap-[30px] mr-[50px] ">
                        ...
                        <NavLink to='/Connecting' className='w-[80px]'> ارتباط با ما </NavLink>
                    </div>
                ...
                <div className='flex pt-3 h-[70px]'>
                    ...
                    <div className="mr-[250px] absolute z-20">
                        <div className="flex gap-[30px] mr-[50px] ">
                            ...
                            <NavLink className="text-white" to='/courses'> دوره ها </NavLink>
                            <NavLink className="text-white" to='/Articles'> مقالات </NavLink>
