...
const ThirdStep = ({setStepCounter}) => {
    ...
    <h1 className='text-center text-white font-normal text-3xl leading-10'> ثبت نام نهایی </h1>
      ...
      <div className='w-[350px] h-[45px] mx-auto mt-[20px]'>
          ...
          <Formik initialValues={{email:'',password:''}} onSubmit={handleThird} >
            ...
            <div className='flex justify-center'> 
                <button type='submit' className='text-[#fff] border-2 bg-gradient-to-r rounded-full from-[#732AFF] to-[#4545FF] mt-[35px] h-[42px] w-[200px]'>
                  تکمیل ثبت نام
                </button>
             </div>
        ...
        <div className='steps flex mt-[170px] relative'>
      ...
      <div className='flex h-[40px] mt-[70px] mx-auto justify-center ' >
        ...
        <div  className='w-[40px] h-[40px]  border-2 border-gray-700 rounded-xl text-[#3F40EA] bg-[#732AFF] leading-8 text-center'>
      ...
      <div className='w-[350px] h-[45px] mx-auto mt-[20px]'>
          ...
          <Formik initialValues={{email:'',password:''}} onSubmit={handleThird} >
            <Form>
              ...
              <Field name='password' type='password' placeholder='لطفا رمز خود را وارد کنید'  className='h-[40px] w-[100%] rounded-[10px] mt-[30px]'/>
            <div className='flex justify-center'> 
                <button type='submit' className='text-[#fff] rounded-[5px] border-2 bg-gradient-to-r rounded-full from-[#732AFF] to-[#4545FF] mt-[35px] h-[42px] w-[200px]'>
                  تکمیل ثبت نام
                </button>
             </div>
