    ...
    return (
        <div>
            <div className='block sm:hidden'>
                <div className="px-10 py-10 mt-[50px] h-[800px] w-[95%] mx-auto rounded-xl shadow-[0px_0px_10px_2px_rgba(0,0,0,0.2)]">
                    <h2 className="font-bold text-xl mb-10" > ویدیو ها </h2>
                    <div className='relative w-[90%] h-[300px] mx-auto'>
                        <img className='w-full h-[200px]' src={group117}/>
                        <button className='rounded-full w-[61px] h-[60px] absolute z-40 top-[70px] right-[40%] bg-blue-600'>
                            <img className='my-auto mr-3 w-8 h-8' src={polygon2}/>
                        </button>
                    </div>

                    <div className='border-b-2 border-blue-600 w-[90%] h-14 mx-auto flex'>
                        <div className='w-[80%] flex gap-5'>
                            <div className='w-8 h-8 border-2 border-gray-400 px-[10px] py-[2px] rounded-md'> 1 </div>
                            <h2 className='w-[70%] mt-3'> ویدیو اول : آشنایی با ری اکت </h2>
                        </div>
                        <div className='w-[20%] flex justify-end gap-5'>
                            <div className='pt-8 text-xs'> 00:13:00 </div>
                            <img className='w-6 h-6 mt-6' src={import1}/>
                        </div>
                    </div>
                    ...
                    <div className='border-b-2 border-blue-600 w-[90%] h-14 mx-auto mt-8 flex'>
                        <div className='w-[80%] flex gap-5'>
                            <div className='w-8 h-8 border-2 border-gray-400 px-[10px] py-[2px] rounded-md'> 1 </div>
                            <h2 className='w-[60%]'> ویدیو دوم : دانلود و نصب نرم افزار ها </h2>
                            <img className='w-6 h-6 mt-6' src={lock2}/>
                        </div>
                        <div className='w-[20%] flex justify-end gap-5'>
                            <div className='pt-8 text-xs'> 00:08:00 </div>
                            <img className='w-6 h-6 mt-6' src={import1}/>
                        </div>
                    </div>
                    ...
                    <div className='border-b-2 border-blue-600 w-[90%] h-14 mx-auto mt-8 flex'>
                        <div className='w-[80%] flex gap-5'>
                            <div className='w-8 h-8 border-2 border-gray-400 px-[10px] py-[2px] rounded-md'> 1 </div>
                            <h2 className='mt-6'> ویدیو سوم : ایجاد پروژه </h2>
                            <img className='w-6 h-6 mt-6' src={lock2}/>
                        </div>
                        <div className='w-[20%] flex justify-end gap-5'>
                            <div className='pt-8 text-xs'> 00:12:00 </div>
                            <img className='w-6 h-6 mt-6' src={import1}/>
                        </div>
                    </div>
