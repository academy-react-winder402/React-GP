...
const FirstStep = ({setStepCounter}) => {
  ...
  <>
    ...
    <h1 className='text-center text-[#2416E9] font-normal text-3xl leading-10'>تغییر رمز عبور </h1>
    <p className='leading-5 text-[#A193FF] text-center mt-[40px]'>جهت دریافت کد یک بار مصرف ایمیل  خود را وارد کنید.</p>
